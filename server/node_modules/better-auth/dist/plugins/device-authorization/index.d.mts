import { TimeString } from "../../utils/time.mjs";
...
declare const deviceAuthorization: (options?: Partial<DeviceAuthorizationOptions>) => {
  ...
  endpoints: {
    deviceCode: better_call19.StrictEndpoint<"/device/code", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceToken: better_call19.StrictEndpoint<"/device/token", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceVerify: better_call19.StrictEndpoint<"/device", {
      method: "GET";
      query: z.ZodObject<{
    ...
    deviceApprove: better_call19.StrictEndpoint<"/device/approve", {
      method: "POST";
      body: z.ZodObject<{
    ...
    deviceDeny: better_call19.StrictEndpoint<"/device/deny", {
      method: "POST";
      body: z.ZodObject<{
        userCode: z.ZodString;
      }, z.core.$strip>;
