...
declare const oAuthProxy: (opts?: OAuthProxyOptions | undefined) => {
  ...
  endpoints: {
    oAuthProxy: better_call76.StrictEndpoint<"/oauth-proxy-callback", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
      ...
      use: ((inputContext: better_call76.MiddlewareInputContext<better_call76.MiddlewareOptions>) => Promise<void>)[];
      metadata: {
        openapi: {
          operationId: string;
          description: string;
