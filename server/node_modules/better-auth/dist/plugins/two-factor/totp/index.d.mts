...
declare const totp2fa: (options?: TOTPOptions | undefined) => {
  ...
  endpoints: {
     ...
     */
    generateTOTP: better_call756.StrictEndpoint<string, {
      method: "POST";
      body: z.ZodObject<{
        secret: z.ZodString;
      }, z.core.$strip>;
     ...
     */
    getTOTPURI: better_call756.StrictEndpoint<"/two-factor/get-totp-uri", {
      method: "POST";
     ...
     */
    verifyTOTP: better_call756.StrictEndpoint<"/two-factor/verify-totp", {
      method: "POST";
      body: z.ZodObject<{
        code: z.ZodString;
