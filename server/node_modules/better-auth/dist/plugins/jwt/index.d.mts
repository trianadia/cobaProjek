...
import { getJwtToken } from "./sign.mjs";
import { createJwk, generateExportedKeyPair } from "./utils.mjs";
...
declare const jwt: (options?: JwtOptions | undefined) => {
  ...
  endpoints: {
    getJwks: better_call66.StrictEndpoint<string, {
      method: "GET";
      metadata: {
        openapi: {
          operationId: string;
    ...
    getToken: better_call66.StrictEndpoint<"/token", {
      method: "GET";
      requireHeaders: true;
    ...
    signJWT: better_call66.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
    ...
    verifyJWT: better_call66.StrictEndpoint<string, {
      method: "POST";
      metadata: {
        $Infer: {
          body: {
...
//#endregion
export { JWKOptions, JWSAlgorithms, Jwk, JwtOptions, createJwk, generateExportedKeyPair, getJwtToken, jwt, verifyJWT };
