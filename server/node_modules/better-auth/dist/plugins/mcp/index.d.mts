...
import * as better_call261 from "better-call";
...
declare const mcp: (options: MCPOptions) => {
  ...
  hooks: {
    after: {
      matcher(): true;
      handler: (inputContext: better_call261.MiddlewareInputContext<better_call261.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  endpoints: {
    oAuthConsent: better_call261.StrictEndpoint<"/oauth2/consent", {
      method: "POST";
      operationId: string;
      body: z.ZodObject<{
        accept: z.ZodBoolean;
      ...
      use: ((inputContext: better_call261.MiddlewareInputContext<better_call261.MiddlewareOptions>) => Promise<{
        session: {
    ...
    getMcpOAuthConfig: better_call261.StrictEndpoint<"/.well-known/oauth-authorization-server", {
      method: "GET";
      metadata: {
        readonly scope: "server";
      };
    }, OIDCMetadata | null>;
    getMCPProtectedResource: better_call261.StrictEndpoint<"/.well-known/oauth-protected-resource", {
      method: "GET";
      metadata: {
        readonly scope: "server";
      };
    ...
    mcpOAuthAuthorize: better_call261.StrictEndpoint<"/mcp/authorize", {
      method: "GET";
    ...
    mcpOAuthToken: better_call261.StrictEndpoint<"/mcp/token", {
      method: "POST";
    ...
    registerMcpClient: better_call261.StrictEndpoint<"/mcp/register", {
      method: "POST";
      body: z.ZodObject<{
    ...
    getMcpSession: better_call261.StrictEndpoint<"/mcp/get-session", {
      method: "GET";
      requireHeaders: true;
