...
import * as better_call232 from "better-call";
...
declare const username: (options?: UsernameOptions | undefined) => {
  ...
  endpoints: {
    signInUsername: better_call232.StrictEndpoint<"/sign-in/username", {
      method: "POST";
      body: z.ZodObject<{
    ...
    isUsernameAvailable: better_call232.StrictEndpoint<"/is-username-available", {
      method: "POST";
      body: z.ZodObject<{
        username: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call232.MiddlewareInputContext<better_call232.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  $ERROR_CODES: {
