...
import * as better_call74 from "better-call";
...
declare const siwe: (options: SIWEPluginOptions) => {
  ...
  endpoints: {
    getSiweNonce: better_call74.StrictEndpoint<"/siwe/nonce", {
      method: "POST";
      body: z.ZodObject<{
    ...
    verifySiweMessage: better_call74.StrictEndpoint<"/siwe/verify", {
      method: "POST";
      body: z.ZodObject<{
        message: z.ZodString;
