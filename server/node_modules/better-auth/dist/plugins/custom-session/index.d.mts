...
declare const customSession: <Returns extends Record<string, any>, O extends BetterAuthOptions = BetterAuthOptions>(fn: (session: {
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call6.MiddlewareInputContext<better_call6.MiddlewareOptions>) => Promise<Awaited<Returns>[] | undefined>;
    }[];
  };
  endpoints: {
    getSession: better_call6.StrictEndpoint<"/get-session", {
      method: "GET";
