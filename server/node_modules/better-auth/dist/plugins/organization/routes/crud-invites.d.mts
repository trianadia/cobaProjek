...
import * as _better_auth_core_db111 from "@better-auth/core/db";
import * as z from "zod";
import * as better_call886 from "better-call";

//#region src/plugins/organization/routes/crud-invites.d.ts
declare const createInvitation: <O extends OrganizationOptions>(option: O) => better_call886.StrictEndpoint<"/organization/invite-member", {
  method: "POST";
  requireHeaders: true;
  use: (((inputContext: better_call886.MiddlewareInputContext<better_call886.MiddlewareOptions>) => Promise<{
    ...
    getSession: (context: _better_auth_core54.GenericEndpointContext) => Promise<{
      session: _better_auth_core_db111.Session & {
        activeTeamId?: string | undefined;
        activeOrganizationId?: string | undefined;
      };
      user: _better_auth_core_db111.User;
    }>;
...
declare const acceptInvitation: <O extends OrganizationOptions>(options: O) => better_call886.StrictEndpoint<"/organization/accept-invitation", {
  method: "POST";
  body: z.ZodObject<{
...
declare const rejectInvitation: <O extends OrganizationOptions>(options: O) => better_call886.StrictEndpoint<"/organization/reject-invitation", {
  method: "POST";
  body: z.ZodObject<{
    invitationId: z.ZodString;
  }, z.core.$strip>;
...
declare const cancelInvitation: <O extends OrganizationOptions>(options: O) => better_call886.StrictEndpoint<"/organization/cancel-invitation", {
  method: "POST";
  body: z.ZodObject<{
    invitationId: z.ZodString;
  }, z.core.$strip>;
...
declare const getInvitation: <O extends OrganizationOptions>(options: O) => better_call886.StrictEndpoint<"/organization/get-invitation", {
  method: "GET";
  use: ((inputContext: better_call886.MiddlewareInputContext<better_call886.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
...
declare const listInvitations: <O extends OrganizationOptions>(options: O) => better_call886.StrictEndpoint<"/organization/list-invitations", {
  method: "GET";
  requireHeaders: true;
  use: (((inputContext: better_call886.MiddlewareInputContext<better_call886.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
 ...
 */
declare const listUserInvitations: <O extends OrganizationOptions>(options: O) => better_call886.StrictEndpoint<"/organization/list-user-invitations", {
  method: "GET";
  use: ((inputContext: better_call886.MiddlewareInputContext<better_call886.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
