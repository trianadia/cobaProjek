...
import * as better_call854 from "better-call";

//#region src/plugins/organization/routes/crud-org.d.ts
declare const createOrganization: <O extends OrganizationOptions>(options?: O | undefined) => better_call854.StrictEndpoint<"/organization/create", {
  method: "POST";
  body: z.ZodObject<{
    name: z.ZodString;
    slug: z.ZodString;
  ...
  use: ((inputContext: better_call854.MiddlewareInputContext<better_call854.MiddlewareOptions>) => Promise<{
...
declare const checkOrganizationSlug: <O extends OrganizationOptions>(options: O) => better_call854.StrictEndpoint<"/organization/check-slug", {
  method: "POST";
  body: z.ZodObject<{
    slug: z.ZodString;
  }, z.core.$strip>;
  ...
  }>) | ((inputContext: better_call854.MiddlewareInputContext<better_call854.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
      [key: string]: Role<{}>;
    };
...
declare const updateOrganization: <O extends OrganizationOptions>(options?: O | undefined) => better_call854.StrictEndpoint<"/organization/update", {
  method: "POST";
  body: z.ZodObject<{
    data: z.ZodObject<{
...
declare const deleteOrganization: <O extends OrganizationOptions>(options: O) => better_call854.StrictEndpoint<"/organization/delete", {
  method: "POST";
  body: z.ZodObject<{
...
declare const getFullOrganization: <O extends OrganizationOptions>(options: O) => better_call854.StrictEndpoint<"/organization/get-full-organization", {
  method: "GET";
  ...
  }>) | ((inputContext: better_call854.MiddlewareInputContext<{
    use: ((inputContext: better_call854.MiddlewareInputContext<better_call854.MiddlewareOptions>) => Promise<{
      session: {
        session: Record<string, any> & {
          id: string;
...
declare const setActiveOrganization: <O extends OrganizationOptions>(options: O) => better_call854.StrictEndpoint<"/organization/set-active", {
  method: "POST";
  body: z.ZodObject<{
...
declare const listOrganizations: <O extends OrganizationOptions>(options: O) => better_call854.StrictEndpoint<"/organization/list", {
  method: "GET";
  use: (((inputContext: better_call854.MiddlewareInputContext<better_call854.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
