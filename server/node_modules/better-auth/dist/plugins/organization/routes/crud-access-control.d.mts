...
import * as better_call922 from "better-call";
...
declare const createOrgRole: <O extends OrganizationOptions>(options: O) => better_call922.StrictEndpoint<"/organization/create-role", {
  method: "POST";
  body: z.ZodObject<{
  ...
  requireHeaders: true;
  use: ((inputContext: better_call922.MiddlewareInputContext<{
    use: ((inputContext: better_call922.MiddlewareInputContext<better_call922.MiddlewareOptions>) => Promise<{
      session: {
...
declare const deleteOrgRole: <O extends OrganizationOptions>(options: O) => better_call922.StrictEndpoint<"/organization/delete-role", {
  method: "POST";
...
declare const listOrgRoles: <O extends OrganizationOptions>(options: O) => better_call922.StrictEndpoint<"/organization/list-roles", {
  method: "GET";
  requireHeaders: true;
  use: ((inputContext: better_call922.MiddlewareInputContext<{
    use: ((inputContext: better_call922.MiddlewareInputContext<better_call922.MiddlewareOptions>) => Promise<{
...
declare const getOrgRole: <O extends OrganizationOptions>(options: O) => better_call922.StrictEndpoint<"/organization/get-role", {
  method: "GET";
  requireHeaders: true;
  use: ((inputContext: better_call922.MiddlewareInputContext<{
    use: ((inputContext: better_call922.MiddlewareInputContext<better_call922.MiddlewareOptions>) => Promise<{
...
declare const updateOrgRole: <O extends OrganizationOptions>(options: O) => better_call922.StrictEndpoint<"/organization/update-role", {
  method: "POST";
  body: z.ZodIntersection<z.ZodObject<{
    organizationId: z.ZodOptional<z.ZodString>;
    data: z.ZodObject<{
