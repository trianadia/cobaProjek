...
import * as _better_auth_core_db64 from "@better-auth/core/db";
import * as z from "zod";
import * as better_call816 from "better-call";

//#region src/plugins/organization/routes/crud-members.d.ts
declare const addMember: <O extends OrganizationOptions>(option: O) => better_call816.StrictEndpoint<string, {
  method: "POST";
  body: z.ZodObject<{
  ...
  use: ((inputContext: better_call816.MiddlewareInputContext<better_call816.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
      [key: string]: Role<{}>;
    };
    getSession: (context: _better_auth_core40.GenericEndpointContext) => Promise<{
      session: _better_auth_core_db64.Session & {
        activeTeamId?: string | undefined;
        activeOrganizationId?: string | undefined;
      };
      user: _better_auth_core_db64.User;
    }>;
  }>)[];
  metadata: {
    $Infer: {
...
declare const removeMember: <O extends OrganizationOptions>(options: O) => better_call816.StrictEndpoint<"/organization/remove-member", {
  method: "POST";
  body: z.ZodObject<{
  ...
  }>) | ((inputContext: better_call816.MiddlewareInputContext<{
    use: ((inputContext: better_call816.MiddlewareInputContext<better_call816.MiddlewareOptions>) => Promise<{
      session: {
...
declare const updateMemberRole: <O extends OrganizationOptions>(option: O) => better_call816.StrictEndpoint<"/organization/update-member-role", {
  method: "POST";
  body: z.ZodObject<{
    role: z.ZodUnion<readonly [z.ZodString, z.ZodArray<z.ZodString>]>;
...
declare const getActiveMember: <O extends OrganizationOptions>(options: O) => better_call816.StrictEndpoint<"/organization/get-active-member", {
  method: "GET";
  use: (((inputContext: better_call816.MiddlewareInputContext<better_call816.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
...
declare const leaveOrganization: <O extends OrganizationOptions>(options: O) => better_call816.StrictEndpoint<"/organization/leave", {
  method: "POST";
  body: z.ZodObject<{
  ...
  }>) | ((inputContext: better_call816.MiddlewareInputContext<better_call816.MiddlewareOptions>) => Promise<{
    orgOptions: OrganizationOptions;
    roles: typeof defaultRoles & {
      [key: string]: Role<{}>;
    };
...
declare const listMembers: <O extends OrganizationOptions>(options: O) => better_call816.StrictEndpoint<"/organization/list-members", {
  method: "GET";
...
declare const getActiveMemberRole: <O extends OrganizationOptions>(options: O) => better_call816.StrictEndpoint<"/organization/get-active-member-role", {
  method: "GET";
  query: z.ZodOptional<z.ZodObject<{
