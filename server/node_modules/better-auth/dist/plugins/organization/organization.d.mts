...
import * as better_call679 from "better-call";
...
declare const createHasPermission: <O extends OrganizationOptions>(options: O) => better_call679.StrictEndpoint<"/organization/has-permission", {
  method: "POST";
  requireHeaders: true;
  ...
  use: ((inputContext: better_call679.MiddlewareInputContext<{
    use: ((inputContext: better_call679.MiddlewareInputContext<better_call679.MiddlewareOptions>) => Promise<{
      session: {
