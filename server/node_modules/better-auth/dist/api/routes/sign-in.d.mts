...
import * as better_call724 from "better-call";
...
declare const signInSocial: <O extends BetterAuthOptions>() => better_call724.StrictEndpoint<"/sign-in/social", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    callbackURL: z.ZodOptional<z.ZodString>;
...
declare const signInEmail: <O extends BetterAuthOptions>() => better_call724.StrictEndpoint<"/sign-in/email", {
  method: "POST";
  operationId: string;
  body: z.ZodObject<{
    email: z.ZodString;
